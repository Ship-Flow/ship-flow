...
import com.shipflow.orderservice.infrastructure.messaging.event.inbound.ProductStockDecreasedEvent;
...
public class StockDecreasedHandler extends AbstractSagaHandler<ProductStockDecreasedEvent> {
    ...
    @RabbitListener(queues = RabbitMqConfig.QUEUE_ORDER_STOCK_DECREASED)
