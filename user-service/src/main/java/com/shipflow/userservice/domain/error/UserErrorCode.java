...
public enum UserErrorCode implements ErrorCode {
	...
	DELETE_REQUEST_FAILED(HttpStatus.BAD_REQUEST, "U005", "사용자 삭제 요청에 실패하였습니다."),
	USER_NOT_FOUND(HttpStatus.NOT_FOUND, "U006", "사용자를 찾을 수 없습니다."),
	ACCESS_DENIED(HttpStatus.FORBIDDEN, "U007", "해당 작업에 대한 권한이 없습니다."),
	HUB_MANAGER_DELETE_FORBIDDEN(HttpStatus.FORBIDDEN, "U008", "해당 허브관리자를 삭제할 수 없습니다.");
