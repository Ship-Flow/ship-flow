...
import com.shipflow.shipmentservice.infrastructure.messaging.event.publish.ShipmentCompletedSagaEvent;
...
public class ShipmentEventPublisherImpl implements ShipmentEventPublisher {
	...
	@Override
	public void publishCompleted(ShipmentCompletedEvent event) {
		eventPublisher.publish(new ShipmentCompletedSagaEvent(event));
	}
}
