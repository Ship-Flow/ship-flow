...
public class Company extends BaseEntity{
    ...
    public static Company create(UUID id, String name,
        ...
        return new Company(id, name, type,hubId, address,managerId, managerName, createdBy);
    }
    ...
    public void updateByAdmin(String name, CompanyType type, UUID hubId,
        ...
        if(name!=null && !name.isBlank() || address!=null && !address.isBlank()) updateBasic(name, address);
